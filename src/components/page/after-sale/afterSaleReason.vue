<template>
    <div class="config-management-container container-wrap">
                        ...
                        <div slot="label">
                            ...
                            <el-collapse-transition>
                                <div class="reason-list" @click.stop="" v-show="reasonTypeShow">
                                    <ul>
                                        <li v-for="item in reasonOptions" @click.stop="selectReasonItem(item.key, item.name)" :class="{ is_selected: reasonLabel === item.name }">
                                            <span>{{ item.name }}</span>
                                        </li>
                                    </ul>
                                </div>
                ...
                <el-table-column label="操作" width="240">
                    <template slot-scope="scope">
                        <div style="display: inline-block">
                            <el-button type="text" class="marginRight32" v-hasPermission="'mall-backend-reason-update'" @click="handleEdit(scope.$index, scope.row)"
                                >编辑</el-button
                            >
                        </div>
                        <div style="display: inline-block">
                            <el-button type="text" class="delete-color marginLeft0" v-hasPermission="'mall-backend-reason-delete'" @click="handleDelete(scope.$index, scope.row)"
                                >删除</el-button
                            >
                        </div>
                    </template>
        ...
        <el-dialog
            ...
            width="380px"
            :before-close="attrDialogClose"
            :destroy-on-close="true"
            :close-on-click-modal="false"
            ustom-class="attrDialog"
        >
