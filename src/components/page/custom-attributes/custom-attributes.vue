    ...
    <div class="custom-attr-page container-wrap">
        <div class="container container-table-no-search p-t-0">
            ...
            <div class="tabs-and-add">
                ...
                <div>
                    <el-button class="btn-add" type="primary" v-hasPermission="'mall-backend-consume-attr-create'" @click="handleCreateAuthority" v-if="activeName == 'change'">
                        新增属性
                    </el-button>
                </div>
            </div>
            ...
            <el-table :data="tableData" style="width: 100%" :height="$tableHeight" class="pagination-container">
                ...
                <el-table-column label="操作" width="160" align="left">
                    <template slot-scope="scope" v-if="scope.row.is_edit == 1">
                        <el-button type="text" class="marginRight32 m-l-0" v-hasPermission="'mall-backend-consume-attr-update'" @click="handleEdit(scope.$index, scope.row)"
                            >编辑</el-button
                        >
                        <el-button type="text" class="delete-color m-l-0" v-hasPermission="'mall-backend-consume-attr-delete'" @click="handleDelete(scope.$index, scope.row)"
                            >删除</el-button
                        >
                    </template>
                </el-table-column>
