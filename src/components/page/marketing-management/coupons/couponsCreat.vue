    ...
    <div class="app-container operation-container">
        <el-form class="freight-form" label-position="right" :model="operationForm" :rules="rules" ref="operationForm" label-width="100px">
            ...
            <div class="form-content">
                <el-form-item class="form-item" label="优惠券类型:" prop="type">
                    <el-radio-group v-model="operationForm.type" :disabled="operationTitle === '编辑优惠券'" @change="chooseCouponsType">
                        <el-radio :label="1">满减</el-radio>
                        <el-radio :label="2">折扣</el-radio>
                    </el-radio-group>
                </el-form-item>
                <el-form-item class="form-item" label="优惠券名称:" prop="title">
                    <el-input class="w300" placeholder="请输入名称" v-model="operationForm.title" :disabled="operationTitle === '编辑优惠券'" />
                </el-form-item>
                <el-form-item class="form-item" label="使用门槛:" prop="threshold" required>
                    <el-radio-group v-model="operationForm.threshold" :disabled="operationTitle === '编辑优惠券'" @change="chooseThresholdType">
                        ...
                        <el-radio :label="2">
                            ...
                            >
                                <el-input class="w100" placeholder="" v-model.number="operationForm.with_amount" :disabled="operationTitle === '编辑优惠券'"></el-input>
                            </el-form-item>
                            元可用
                        </el-radio>
                    </el-radio-group>
                ...
                >
                    <el-input class="w300" placeholder="" v-model="operationForm.coupon_amount" v-if="operationForm.type > 1" :disabled="operationTitle === '编辑优惠券'">
                        <template slot="append" class="append-unit">折</template>
                    </el-input>
                    <el-input class="w300" placeholder="" v-model.number="operationForm.coupon_amount" v-else :disabled="operationTitle === '编辑优惠券'">
                ...
                <el-form-item class="form-item" label="封顶金额:" prop="have_discount_top" required v-if="operationForm.type === 2">
                    <el-radio-group v-model="operationForm.have_discount_top" :disabled="operationTitle === '编辑优惠券'" @change="disTopChange">
                        ...
                        <el-radio :label="2">
                            ...
                            >
                                <el-input class="w100" placeholder="" v-model.number="operationForm.discount_top" :disabled="operationTitle === '编辑优惠券'"></el-input>
                            </el-form-item>
                            元
                        </el-radio>
                    </el-radio-group>
                ...
                <el-form-item class="form-item" label="有效期:" prop="valid_type">
                    <el-radio-group v-model="operationForm.valid_type" @change="chooseValidityType" :disabled="operationTitle === '编辑优惠券'">
                ...
                <el-form-item class="form-item" label="领取后天数:" prop="valid_days" v-if="operationForm.valid_type === 1">
                    <el-input class="w300" placeholder="" v-model.number="operationForm.valid_days" :disabled="operationTitle === '编辑优惠券'">
                        <template slot="append" class="append-unit">天</template>
                    </el-input>
                </el-form-item>
                <template v-if="operationForm.valid_type === 2">
                    <el-form-item class="form-item inline-block" label="有效期间:" prop="valid_start_time" :disabled="operationTitle === '编辑优惠券'">
                        <el-date-picker
                            style="width:200px"
                            class="filter-item"
                ...
                <el-form-item class="form-item" label="发放数量:" prop="quota">
                    <el-input class="w300" placeholder="" v-model.number="operationForm.quota" :disabled="operationTitle === '编辑优惠券'" />
                </el-form-item>
                ...
                <el-form-item class="form-item" label="单用户领取次数:" prop="person_get_type" required label-width="120">
                    <el-radio-group v-model="operationForm.person_get_type" :disabled="operationTitle === '编辑优惠券'" @change="disTopChange">
                        ...
                        <el-radio :label="2">
                            ...
                            >
                                <el-input class="w100" placeholder="" v-model.number="operationForm.person_get_count" :disabled="operationTitle === '编辑优惠券'"></el-input>
                            </el-form-item>
                            次
                        </el-radio>
                    </el-radio-group>
                ...
                <el-form-item class="form-item" label="领取用户:" prop="receive_user">
                    <el-radio-group v-model="operationForm.receive_user" :disabled="operationTitle === '编辑优惠券'">
                        <el-radio :label="1">店铺全体用户</el-radio>
                    </el-radio-group>
                </el-form-item>
                <el-form-item class="form-item" label="可用商品:" prop="use_goods_type">
                    <el-radio-group v-model="operationForm.use_goods_type" :disabled="operationTitle === '编辑优惠券'" @change="useGoodsTypeChange">
...
<script>
import { mixinsCoupons } from '../../../mixins/coupons'
import './coupons.less'
export default {
    name: 'couponAdd',
    mixins: [mixinsCoupons],
    data() {
        return {}
    },
    created() {},
