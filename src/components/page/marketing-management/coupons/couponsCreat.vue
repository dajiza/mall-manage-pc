        ...
        >
            ...
            <div class="form-content">
                ...
                <el-form-item class="form-item" label="使用门槛:" prop="threshold" required>
                    <el-radio-group
                            v-model="operationForm.threshold"
                            :disabled="operationTitle === '编辑优惠券'"
                            @change="chooseThresholdType"
                    >
                        ...
                        <el-radio :label="2">
                            ...
                            >
                                <el-input
                                    class="w100"
                                    placeholder=""
                                    v-model.number="operationForm.with_amount"
                                    :disabled="operationTitle === '编辑优惠券'"
                                ></el-input>
                            </el-form-item>
                            元可用
                        ...
                        <el-radio :label="2">
                            ...
                            >
                                <el-input
                                    class="w100"
                                    placeholder=""
                                    v-model.number="operationForm.discount_top"
                                    :disabled="operationTitle === '编辑优惠券'"
                                ></el-input>
                            </el-form-item>
                            元
                ...
                <el-form-item class="form-item" label="有效期:" prop="valid_type">
                    <el-radio-group
                            v-model="operationForm.valid_type"
                            @change="chooseValidityType"
                            :disabled="operationTitle === '编辑优惠券'"
                    >
                ...
                <el-form-item class="form-item" label="发放数量:" prop="quota">
                    <el-input
                        class="w300"
                        placeholder=""
                        v-model.number="operationForm.quota"
                        :disabled="operationTitle === '编辑优惠券'"
                    />
                </el-form-item>
                        ...
                        <el-radio :label="2">
                            ...
                            >
                                <el-input
                                        class="w100"
                                        placeholder=""
                                        v-model.number="operationForm.person_get_count"
                                        :disabled="operationTitle === '编辑优惠券'"
                                ></el-input>
                            </el-form-item>
                            次
                ...
                <el-form-item class="form-item" label="领取用户:" prop="receive_user">
                    <el-radio-group
                            v-model="operationForm.receive_user"
                            :disabled="operationTitle === '编辑优惠券'"
                    >
                ...
                <el-form-item class="form-item" label="可用商品:" prop="use_goods_type">
                    <el-radio-group
                        v-model="operationForm.use_goods_type"
                        :disabled="operationTitle === '编辑优惠券'"
                        @change="useGoodsTypeChange"
                    >
